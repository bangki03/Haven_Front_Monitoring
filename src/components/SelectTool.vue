    ...
    return {
      ...
      hitOptions: {
        ...
        match: hit => {
          ...
          return !Object.prototype.hasOwnProperty.call(hit.item, 'indicator')
        }
      }
    };
  },
  methods: {
    ...
    onMouseMove(event) {
      ...
      if (
        ...
        item && Object.prototype.hasOwnProperty.call(item.data, 'annotationId') && Object.prototype.hasOwnProperty.call(item.data, 'categoryId')
        ...
        event.item && Object.prototype.hasOwnProperty.call(event.item, 'keypoint')
        ) {
        this.hover.position = event.point;
        this.keypoint = item;
      } else if (
        ...
        item && item.lastChild && Object.prototype.hasOwnProperty.call(item.lastChild, 'keypoint')
      ) {
        this.hover.position = event.point;
        for (let i = 0; i < item.children.length; ++i) {
          if (
            // item.children[i].hasOwnProperty("keypoint")
            Object.prototype.hasOwnProperty.call(item.children[i], 'keypoint')
            ) {
